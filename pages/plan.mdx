...
4. **Directives Structurelles Angular (30 minutes)**
...
5. **Gestion de l'état avec NgRx (30 minutes)**
   - Introduction à NgRx
   - Création d'actions, reducers et stores
   - Utilisation de sélecteurs pour accéder à l'état

6. **Formulaires et validation dans Angular (30 minutes)**
...
7. **Routage avec Angular Router (30 minutes)**
   - Introduction à Angular Router
   - Création de routes dynamiques
   - Navigation programmatique

8. **Déploiement d'une application Angular (15 minutes)**
